                            ...
                            @if ($data->isEmpty())
                                <tr>
                                    <td colspan="6" class="text-center py-4">
                                        <p class="text-gray-400 dark:text-gray-600">Geen producten gevonden.</p>
                                    </td>
                                </tr>
                                
                            @else
                                @foreach ($data as $key => $product)
                                    <tr class="hover:cursor-pointer hover:bg-gray-200" onclick="window.location='{{ route('products.edit', $product->id) }}'">
                                        <td
