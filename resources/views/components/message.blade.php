@if (session()->has('message'))
    <!-- Code block starts -->
    <div class="flex items-center justify-center fixed w-full bottom-8 px-4">
        <div role="alert" id="alert"
            class="transition duration-150 ease-in-out w-full lg:w-11/12 mx-auto bg-white dark:bg-slate-700 shadow rounded flex flex-col py-4 md:py-0 items-center md:flex-row justify-between">
            <div class="flex flex-col items-center md:flex-row">
                ...
                <p class="mr-2 text-base font-bold text-gray-800 dark:text-gray-100 mt-2 md:my-0">Melding
                </p>
            ...
            <div class="flex xl:items-center lg:items-center sm:justify-end justify-center pr-4">
                {{-- <button
                    class="focus:outline-none focus:text-indigo-400 hover:text-indigo-400 text-sm mr-4 font-bold cursor-pointer text-indigo-700 dark:text-indigo-600">Details</button> --}}
                <button
                    class="focus:outline-none focus:text-gray-400 hover:text-gray-400 text-sm cursor-pointer text-gray-600 dark:text-gray-400"
                    onclick="closeAlert()">Sluiten</button>
            </div>
        </div>
    </div>
    <!-- Code block ends -->
    ...
    <script>
        ...
        function closeAlert() {
            ...
            setTimeout(function() {
                Alert.style.transform = "translateY(-400%)";
