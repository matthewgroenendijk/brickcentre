        ...
        <div class="dark:bg-gray-900 shadow-xl bg-gray-50 px-6 py-9">
            <div class="container mx-auto flex items-center justify-between">
                <h1 class="md:w-2/12 cursor-pointer font-bold text-gray-800 dark:text-yellow-500"
                    aria-label="the Crib.">
                    <span class="dark:text-white text-yellow-500">Brick</span>Centre.
                </h1>
                <ul class="hidden w-8/12 md:flex items-center justify-center space-x-8">
                    ...
                    <li>
                        <a href="{{ route('orders.index') }}"
                            class="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">Orders</a>
                    </li>
                    <li class="dropdown">
                        <a href="{{ route('products.index') }}"
                            class="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">Products</a>
                        <div class="dropdown-content">
                            <a href="{{ route('products.index') }}">Verkoop Producten</a>
                            <a href="{{ route('products.index') }}">Verhuur Producten</a>
                        </div>
                    </li>
                </ul>
