          ...
          <form action="#" class="mt-8 grid grid-cols-6 gap-6" method="POST">
            ...
            <div class="col-span-6">
              ...
              <input
                ...
                id="Email"
                name="email"
                class="mt-1 p-2 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
              />
            </div>
            ...
            <div class="col-span-6 sm:flex sm:items-center sm:gap-4">
              ...
              <p class="mt-4 text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
                Wil je naar The World of Bricks site?
