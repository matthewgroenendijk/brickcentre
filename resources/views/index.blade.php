        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div>
                <div
                    ...
                    <h5 class="text-xl text-gray-700 dark:text-gray-300">Orders</h5>
                    <div class="my-8">
                        <h1 class="text-5xl font-bold text-gray-800 dark:text-white">64,5%</h1>
                        <span class="text-gray-500 dark:text-gray-400">Vergeleken met laatste week</span>
                    </div>
                    ...
                    <table class="mt-6 -mb-2 w-full  text-gray-600">
                        <tbody>
                            <tr class="dark:text-gray-300">
                                <td class="py-2">Afgelopen maand</td>
                                <td class="text-gray-500">896</td>
                                <td>
                                    <div class="h-4 w-24 float-right">
                                        <canvas id="chart3" height="70"></canvas>
                                    </div>
                                </td>
                            </tr>
                            <tr class="dark:text-gray-300">
                                <td class="py-2">Huidige maand</td>
            ...
            <div class="w-full grid grid-rows-2 gap-4 px-2 ">
                <div
                    class="rounded-lg shadow-sm h-full h-full space-y-6 group p-6 sm:p-8 rounded-3xl bg-white border border-gray-200/50 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10">
                ...
                <div
                    class="rounded-lg shadow-sm h-full space-y-6 group p-6 sm:p-8 rounded-3xl bg-white border border-gray-200/50 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10">
                    <div class="h-full relative overflow-hidden">
                        <div class="px-3 pt-8 pb-10 text-center relative z-10">
                            <h4 class="text-sm uppercase text-gray-500 leading-tight">Subscribers</h4>
                            <h3 class="text-3xl text-gray-700 font-semibold leading-tight my-3">11,427</h3>
            ...
            <div class="md:col-span-2 lg:col-span-1">
                <div
                    ...
                    <svg class="m-auto w-40 opacity-75" viewBox="0 0 146 146" fill="none"
                    ...
                    <div>
                        ...
                        <span class="block text-center text-gray-500 dark:text-gray-400">Compared to last week
                            $13,988</span>
                    </div>
            ...
            <div>
                <div
                    class="h-64 group p-6 sm:p-8 rounded-3xl bg-white border border-gray-200/50 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10">
                    <h5 class="text-xl text-gray-700 dark:text-gray-300">Orders</h5>
                    <div class="my-8">
                        <h1 class="text-5xl font-bold text-gray-800 dark:text-white">64,5%</h1>
